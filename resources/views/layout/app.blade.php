...
<body>
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                            ...
                            <div data-i18n="Student Area">Student Area</div>
                        </a>

                        <!-- Submenu for Student Area -->
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="{{ route('submitdocuments') }}" class="menu-link">
                                    <i class="menu-icon bx bx-file"></i>
                                    <div data-i18n="Submit Documents">Submit Documents</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="{{ route('showDocumentstatus') }}" class="menu-link">
                                    <i class="menu-icon bx bx-list-ul"></i>
                                    <div data-i18n="Document Status">Document Status</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="{{ route('student.courses') }}" class="menu-link">
                                    <i class="menu-icon bx bx-list-ul"></i>
                                    <div data-i18n="Document Status">My Courses</div>
                                </a>
                            </li>
                            <li class="menu-item">
                    ...
                    <li class="menu-item">
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="{{ route('showeditprofile') }}" class="menu-link">
                    ...
                    <footer class="content-footer footer bg-footer-theme">
                        <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                            <div class="mb-2 mb-md-0">
                                ...
                                , ND 2 computer science project ❤️
                            </div>
                        </div>
                    </footer>
                    <!-- / Footer -->
    ...
    <!-- Include your script only for the student dashboard -->
